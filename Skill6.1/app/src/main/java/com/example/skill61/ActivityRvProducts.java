...
import com.example.skill61.adapters.RVRetrofitAdapter;
import com.example.skill61.networking.ProductResult;
import com.example.skill61.networking.RetrofitClient;
        ...
        Call<List<ProductResult>> apiCall = RetrofitClient.getInstance().getApis().getProducts();
         apiCall.enqueue(new Callback<List<ProductResult>>() {
             ...
             public void onResponse(Call<List<ProductResult>> call, Response<List<ProductResult>> response) {
                 ...
                 Toast.makeText(ActivityRvProducts.this, "Tengo Productos", Toast.LENGTH_SHORT).show();
